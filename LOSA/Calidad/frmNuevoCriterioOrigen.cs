...
{
    public partial class frmNuevoCriterioOrigen : DevExpress.XtraEditors.XtraForm
    {
        int type = 0;
        int id = 0;
        DataOperations dp = new DataOperations();
        public frmNuevoCriterioOrigen()
        {
            InitializeComponent();
            type = 1;
        ...
        public frmNuevoCriterioOrigen(int Pid, string Pcriterio)
        {
            InitializeComponent();
            id = Pid;
            type = 2;
        ...
        private void btnnuevo_Click(object sender, EventArgs e)
        {
            ...
            if (type == 1)
            {         // nuevo
                string query = "sp_insert_origen_criterio";
