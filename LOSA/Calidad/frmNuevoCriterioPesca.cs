...
{
    public partial class frmNuevoCriterioPesca : DevExpress.XtraEditors.XtraForm
    {
        int type = 0;
        int id = 0;
        DataOperations dp = new DataOperations();
        public frmNuevoCriterioPesca()
        {
            InitializeComponent();
            type = 1;
        ...
        public frmNuevoCriterioPesca(int Pid, string Pcriterio)
        {
            InitializeComponent();
            id = Pid;
            type = 2;
        ...
        private void btnnuevo_Click(object sender, EventArgs e)
        {
            ...
            if (type == 1)
            {         // nuevo
                string query = "sp_insert_pesca_criterio";
            ...
            {
                string query = "sp_update_pesca_criterio";
                SqlConnection cn = new SqlConnection(dp.ConnectionStringLOSA);
                try
                {
                    cn.Open();
