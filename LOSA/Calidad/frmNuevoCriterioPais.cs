...
{
    public partial class frmNuevoCriterioPais : DevExpress.XtraEditors.XtraForm
    {
        int type = 0;
        int id = 0;
        DataOperations dp = new DataOperations();

        public frmNuevoCriterioPais()
        {
            InitializeComponent();
            type = 1;
        ...
        public frmNuevoCriterioPais(int Pid, string Pcriterio)
        {
            InitializeComponent();
            id = Pid;
            type = 2;
        ...
        private void btnnuevo_Click(object sender, EventArgs e)
        {
            ...
            if (type == 1)
            {         // nuevo
                string query = "sp_insert_pais_criterio";
            ...
            {
                string query = "sp_update_pais_criterio";
                SqlConnection cn = new SqlConnection(dp.ConnectionStringLOSA);
                try
                {
                    cn.Open();
