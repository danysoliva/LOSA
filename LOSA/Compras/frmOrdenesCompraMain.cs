    ...
    public partial class frmOrdenesCompraMain : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void TasaCambioActual()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand(query,conn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@fecha_conta", dtFechaContabilizacion.Value.Date);
            ...
            { 
                ...
                case TipoOperacion.New:
                    ...
                    try
                    {
                        ...
                        cmd.CommandText = "sp_CM_insert_ordencompra_h";
                        cmd.Connection = conn;
        ...
        //    this.TsExoOIsv.Location = new System.Drawing.Point(918, 173);
        ...
        //    this.labelControl13.Location = new System.Drawing.Point(748, 175);
        ...
        //    this.btnShowPopu.Location = new System.Drawing.Point(1035, 139);
        ...
        private void reposGrdCapitulo_EditValueChanged(object sender, EventArgs e)
        {
            ...
            {
                CargarPartidasArancelarias(row.Code);
            }
